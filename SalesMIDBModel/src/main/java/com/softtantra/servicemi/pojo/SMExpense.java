...
public class SMExpense implements Serializable{
	private List<SM_ExpenseDetails> expenseDetails = new ArrayList<SM_ExpenseDetails>();
	...
	public List<SM_ExpenseDetails> getExpenseDetails() {
		return expenseDetails;
	}

	public void setExpenseDetails(List<SM_ExpenseDetails> expenseDetails) {
