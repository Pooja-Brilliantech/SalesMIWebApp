...
@Entity
@Table(name = "distributor_scheme_details")
public class DistributorSchemeDetails implements Serializable{

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private int distributor_scheme_detail_id;
	...
	public int getDistributor_scheme_detail_id() {
		return distributor_scheme_detail_id;
	}

	public void setDistributor_scheme_detail_id(int distributor_scheme_detail_id) {
		this.distributor_scheme_detail_id = distributor_scheme_detail_id;
	}
