...
@Entity
@Table(name = "primary_stock_import_records")
public class PrimaryStockImportRecords implements Serializable{
	...
	private int company_location_code;
	...
	public int getCompany_location_code() {
		return company_location_code;
	}

	public void setCompany_location_code(int company_location_code) {
