...
public interface FMLeadService {
	...
	public Map<String, Long> getDataForLeadPieChart(int assigned_to,int created_by,String value,String lead_type,String lead_source,
			String lead_industry,String type,String industry,String source,int c_id,String sqlAssigned_to);
	...
	boolean saveActivity(ActivityDetails activityDetails, int c_id, int u_id);
	...
	boolean saveOpportunityStage(OpportunityStages oppStageObject);
	...
	List<String> getOpportunity_nameList(int c_id);
