...
public interface FMAttendanceDao {

	UserAttendanceReportForToday getAttendanceReportPieChartData(int c_id, int country_id, int state, int city,
	...
	List<UserAttendanceReportForToday> getSlotWiseLocationForCompany(int userId, String pageNo, String pageSize, int c_id,
