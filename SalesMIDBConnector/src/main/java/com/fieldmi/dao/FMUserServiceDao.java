...
public interface FMUserServiceDao {
	...
	boolean updateUserSyncStatus(WSUpdateSyncStatusInput wsUpdateSyncStatusInput, long id);

	List<String> getEmails(List<Integer> list, int c_id);

	boolean renewUserFromEmail(String email, int c_id);

	List<CustomerClassification> getCustomerClassifcation(int c_id);

	boolean deleteMulipleUsers(String user_ids, int c_id);

	List<CompanyLocations> companyLocationList(int c_id);

	List<WsUserAppInfo> getUserAppDetails(int company_id, int user_id);

	boolean updateUserAppVerionAndPermissions(WsUserAppInfo wsUserAppInfo);

	boolean reActivateUser(int user_id, int c_id);

	List<DistributorDetails> getDistributorAndRoute(int company_id,int u_id);
	...
	List<WsUserDashboardDetails> dailyTrendUserLoginData(int c_id);
	
	List<WsUserDashboardDetails> monthlyTrendUserLoginData(int c_id,String start_month, String end_month);

	List<User> getUsers(int distributorId, int c_id);
	...
	List<WsUserDashboardDetails> monthlyTrendUserLogin(int c_id,int year,String activityName);

	List<WsUserDashboardDetails> getUserData(int c_id, String notifcationType, String month,int account);
