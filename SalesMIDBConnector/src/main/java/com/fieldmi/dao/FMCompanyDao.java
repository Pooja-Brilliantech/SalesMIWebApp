...
public interface FMCompanyDao {
	...
	boolean renewAnyObject(String sql);

	int checkCompanyLocationIfExist(String companyLocationName, int c_id);
	...
	boolean addPermissionToCompany(CompanyDetails company, List<String> webPermissions, List<String> mobilePermissions,
			List<String> distributorPermissions);
